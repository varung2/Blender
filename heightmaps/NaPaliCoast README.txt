...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=NaPaliCoast&box=-159.545756,22.257086,-159.730177,22.086406
...
-----------
  ...
  * NaPaliCoast Height Map (ASTER 30m).png
  ...
  * NaPaliCoast Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * NaPaliCoast Height Map (SRTM3 v4.1).png
  ...
  * NaPaliCoast Height Map (SRTM30 Plus).png
  ...
  * NaPaliCoast Height Map (USGS NED 10m).png
